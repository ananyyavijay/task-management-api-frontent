...
const TableHeader = React.forwardRef(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("bg-slate-50/80 [&_tr]:border-b [&_tr]:border-border", className)}
    {...props}
  />
));
...
const TableFooter = React.forwardRef(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t border-border bg-slate-50/60 font-medium", className)}
    {...props}
  />
));
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border transition-colors hover:bg-slate-50/70 data-[state=selected]:bg-secondary",
      className
    )}
    {...props}
  />
